...
public class highjumpoingMonster : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            //GameObject obj = Instantiate(sawblade, throwpoint.position, Quaternion.identity) as GameObject;
    ...
    IEnumerator waitanddropspike()
    {
        ...
        if (effectcount == 200)
        {
            Debug.Log("effect count from waitanddropspike function" + effectcount);
            //effectcount = 0;
